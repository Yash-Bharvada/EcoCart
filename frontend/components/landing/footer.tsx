...
import { Leaf, Twitter, Linkedin, Instagram, Github, Moon, Sun } from 'lucide-react'
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-background">EcoCart</span>
            </Link>
            <p className="text-background/60 text-sm mb-6 max-w-xs">
              Shop smarter for the planet. AI-powered sustainable shopping assistant.
            </p>
            {/* Social Links */}
        ...
        <div className="py-6 border-t border-background/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-background/60">
            © 2024 EcoCart. Built with care and less CO₂
          </p>
          <Button
            variant="ghost"
            size="icon"
